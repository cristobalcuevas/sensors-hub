import { Gauge, Waves, Bubbles, Battery, CircuitBoard, Factory, Thermometer, ThermometerSun, CloudSun, Map, Siren } from 'lucide-react';
      ...
      sensors: [
        {
          ...
          variables: {
            pressure: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_PRESION, name: 'Presión', unit: 'mca', type:'presion', factor: 10.2, icon: Gauge, color: 'sky' },
        ...
        },
        {
          ...
          variables: {
            litres_in: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_LITROS_ENTRADA, name: 'Litros', unit: 'L', type:'litros', icon: Waves, color: 'rose' },
            flow_in: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_CAUDAL_ENTRADA, name: 'Caudal', unit: 'L/s', type:'caudal', icon: Bubbles, color: 'green' },
            temperature_in: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_TEMPERATURA_ENTRADA, name: 'Temperatura ambiente', unit: '°C', type:'temperatura', icon: Thermometer, color: 'violet' },
            humidity_in: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_HUMEDAD_ENTRADA, name: 'Humedad ambiente', unit: '%', type:'humedad', icon: ThermometerSun, color: 'orange' },
        ...
        },
        {
          ...
          variables: {
            litres_out: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_LITROS_SALIDA, name: 'Litros', unit: 'L', type:'litros', icon: Waves, color: 'rose' },
            flow_out: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_CAUDAL_SALIDA, name: 'Caudal', unit: 'L/s', type:'caudal', icon: Bubbles, color: 'green' },
            temperature_out: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_TEMPERATURA_SALIDA, name: 'Temperatura ambiente', unit: '°C', type:'temperatura', icon: Thermometer, color: 'violet' },
            humidity_out: { id: import.meta.env.PUBLIC_UBIDOTS_VOLCAN_HUMEDAD_SALIDA, name: 'Humedad ambiente', unit: '%', type:'humedad', icon: ThermometerSun, color: 'orange' },
      ...
      sensors: [
        {
          ...
          variables: {
            pressure: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_PRESION, name: 'Presión', unit: 'mca', type:'presion', factor: 5.2, icon: Gauge, color: 'sky' },
        ...
        },
        {
          ...
          variables: {
            litres_in: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_LITROS_ENTRADA, name: 'Litros', unit: 'L', type:'litros', icon: Waves, color: 'rose' },
            flow_in: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_CAUDAL_ENTRADA, name: 'Caudal', unit: 'L/s', type:'caudal', icon: Bubbles, color: 'green' },
            temperature_in: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_TEMPERATURA_ENTRADA, name: 'Temperatura ambiente', unit: '°C', type:'temperatura', icon: Thermometer, color: 'violet' },
            humidity_in: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_HUMEDAD_ENTRADA, name: 'Humedad ambiente', unit: '%', type:'humedad', icon: ThermometerSun, color: 'orange' },
        ...
        },
        {
          ...
          variables: {
            litres_out: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_LITROS_SALIDA, name: 'Litros', unit: 'L', type:'litros', icon: Waves, color: 'rose' },
            flow_out: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_CAUDAL_SALIDA, name: 'Caudal', unit: 'L/s', type:'caudal', icon: Bubbles, color: 'green' },
            temperature_out: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_TEMPERATURA_SALIDA, name: 'Temperatura ambiente', unit: '°C', type:'temperatura', icon: Thermometer, color: 'violet' },
            humidity_out: { id: import.meta.env.PUBLIC_UBIDOTS_CANDELARIA_HUMEDAD_SALIDA, name: 'Humedad ambiente', unit: '%', type:'humedad', icon: ThermometerSun, color: 'orange' },
